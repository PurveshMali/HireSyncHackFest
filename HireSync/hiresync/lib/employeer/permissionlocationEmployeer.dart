...
class Permissionlocationemployeer extends StatefulWidget {
  const Permissionlocationemployeer({super.key});

  @override
  State<Permissionlocationemployeer> createState() =>
      _PermissionlocationemployeerState();
}

class _PermissionlocationemployeerState
    extends State<Permissionlocationemployeer> {
  ...
  Future<void> updateUserLocation() async {
    ...
    try {
      ...
      Future.delayed(Duration(seconds: 1), () {
        Navigator.pushReplacementNamed(context, Approutes.homepage_employeer);
      });
    } catch (e) {
